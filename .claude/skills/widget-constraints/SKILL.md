...
description: Non-negotiable constraints for the Wispr AI floating widget window — focus, positioning, security flags, and the complete state table. Read before creating or editing any BrowserWindow, anything under src/main/windows/ or src/renderer/widget/, or any code that positions or shows the widget.
---
